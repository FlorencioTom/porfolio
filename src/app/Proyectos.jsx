  ...
  return (
    <>
      <section id="projects" className="flex flex-col md:justify-between sm:justify-center py-4 px-4 xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md sm:max-w-screen-sm mx-auto">
        <h1 className="flex items-center mb-10 text-3xl font-semibold leading-none tracking-tight text-gray-900 md:text-1xl lg:text-4xl dark:text-white gap-3 justify-center md:justify-start">
                ...
                <p className="mt-2 flex">
                    <a href={project.link} target="_blank">
                        <button type="button" className="flex gap-2 items-center text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                            <i className="fa-solid fa-link"></i>{t('link')}
                        </button>
                    </a>
                </p>
            </div>
